...
public class DecayingMushroomBlockBuilder extends BlockBuilder {

	public DecayingMushroomBlockBuilder(ResourceLocation id) {
		super(id);
		notSolid();
		viewBlocking(false);
		suffocating(false);
	...
	public Block createObject() {
		return new CustomDecayingMushroomBlock(createProperties());
	}
